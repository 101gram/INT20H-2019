...
>{
    private model:      Mongoose.PaginateModel<Mongoose.Document>;
    private aliases:    Vts.Maybe<DocFieldsAliases<TDocData>>;
     ...
     * @param privateOts Defines options that this function will pass directly to 
     *                   mongoose.
     * 
     * 
